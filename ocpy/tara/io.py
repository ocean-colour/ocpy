...
def load_tara_db(dataset='ac'):
    """ Back-compat alias for :func:`load_db` (pre-rename API name).

    Generated by JXP and Claude.

    Args:
        dataset (str): Dataset to load; defaults to ``'ac'`` to match the
            bundled :data:`db_name` parquet.

    Returns:
        pandas.DataFrame: The loaded dataset.
    """
    return load_db(dataset=dataset)
